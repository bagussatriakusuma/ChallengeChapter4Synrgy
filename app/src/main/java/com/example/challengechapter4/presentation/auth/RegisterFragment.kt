...
class RegisterFragment : Fragment() {
    ...
    private fun putDataPref(){
        ...
        editor.putString(Constant.Preferences.PREF_NAME, name)
        editor.putString(Constant.Preferences.PREF_EMAIL, email)
        editor.putString(Constant.Preferences.PREF_PASS, pass)
        editor.putString(Constant.Preferences.PREF_CONFIRM_PASS, conf_pass)
        editor.apply()
